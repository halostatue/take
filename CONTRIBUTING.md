...
Contribution to take is encouraged: bug reports, discussions, feature requests,
...
Take is governed under the [Contributor Covenant Code of Conduct][cccoc].
...
Take contributions must be well understood by the submitter and that the
...
Take projects have adopted a variation of the Conventional Commits format for
...
[issues]: https://github.com/halostatue/take/issues
